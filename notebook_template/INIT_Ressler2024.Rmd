...
path <-  file.path("mnt_data","neoBCC29032022","biomedical-sequencing.at","projects","BSA_0460_MF_BCC_1ab413522d3e4d2d959b1b8f2681cf06","COUNT")
...
samples <- lapply(h5_files, FUN = function (x) gsub(file.path("mnt_data","neoBCC29032022","biomedical-sequencing.at","projects","BSA_0460_MF_BCC_1ab413522d3e4d2d959b1b8f2681cf06","COUNT/"), "", x) )
...
additional_metadata <- read.csv(file.path("../metadata","ADDITIONAL_METADATA.txt"), sep = '\t')
...
reference_TS_skin <- readRDS(file.path("mnt_resources", "/tabula_sapiens/TS_skin_AzimuthReference.rds"))
...
saveRDS(srat, file.path("../data","20241005_Ressler2024_NeoBCC.Rds"))
```
