...
```{r  EDF9b, echo=TRUE, fig.height=4, fig.width=4, message=FALSE, warning=FALSE, out.width='100%'}
...
```{r EDF5c,  echo=TRUE, fig.height=4, fig.width=4, message=FALSE, warning=FALSE, out.width='100%'}
